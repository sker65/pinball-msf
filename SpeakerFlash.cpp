...
static const TProgmemRGBPalette16 speakerPallette PROGMEM = {
		0x00FF00, 0x0000FF, 0xFFD690, 0xFF0000,
		0xFFFF00, 0x00FF00, 0xFF0000, 0x000000,
		0x0000FF, 0x0000FF, 0x0000FF, 0xFFD690,
		0xFFD690, 0x0000FF, 0x000000, 0xFFD690, };

SpeakerFlash::SpeakerFlash(const int* index, int num, const int* index2, int num2,
		int animationSpeed, int holdCycles ) :
		Effect(0, index, num) {
	paletteIndex = 0;
	nextUpdate = 0;
